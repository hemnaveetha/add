    ...
    <FooterWrapper>
        ...
        <div className='footer-content text-white d-grid container'>
          <div className='footer-item'>
            <a href="#" className='navbar-brand text-white text-uppercase no-wrap d-block'>
              NEBULA <span>games</span>
            </a>
            <p className='para-text'>Live gaming with lots of other games. 🚀 Dive into the ultimate gaming adventure! Enjoy stunning graphics, thrilling gameplay, and endless fun. Join the excitement!"
            </p>
          </div>
      ...
      <div className='footer-bottom'>
        <div className='container d-flex flex-column text-center'>
          <p className='footer-bottom-text text-green'>xyz</p>
